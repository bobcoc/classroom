...
CclassroomDlg::CclassroomDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_CLASSROOM_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CclassroomDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_LOGIN, &CclassroomDlg::OnBnClickedButtonLogin)
END_MESSAGE_MAP()
...
void CclassroomDlg::OnBnClickedButtonLogin()
{
	// TODO: 在此添加控件通知处理程序代码
}
